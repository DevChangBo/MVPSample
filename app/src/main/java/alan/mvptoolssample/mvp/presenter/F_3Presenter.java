 ...
 */
@ActivityScope
public class F_3Presenter extends BasePresenter<F_3Contract.Model, F_3Contract.View> implements DialogInterface.OnCancelListener {
    ...
    @Inject
    public F_3Presenter(F_3Contract.Model model, F_3Contract.View rootView
