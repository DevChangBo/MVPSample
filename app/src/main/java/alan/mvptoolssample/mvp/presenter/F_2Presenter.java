 ...
 */
@ActivityScope
public class F_2Presenter extends BasePresenter<F_2Contract.Model, F_2Contract.View> implements DialogInterface.OnCancelListener {
    ...
    @Inject
    public F_2Presenter(F_2Contract.Model model, F_2Contract.View rootView
