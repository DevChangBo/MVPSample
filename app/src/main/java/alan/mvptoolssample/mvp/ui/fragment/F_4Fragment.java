...
import alan.mvptoolssample.di.component.DaggerF_4Component;
 ...
 * ================================================================
 */
public class F_4Fragment extends BaseFragment<F_4Presenter> implements F_4Contract.View {


    public static F_4Fragment newInstance() {
        F_4Fragment fragment = new F_4Fragment();
        return fragment;
    }

    @Override
    public void setupFragmentComponent(AppComponent appComponent) {
        DaggerF_4Component //如找不到该类,请编译一下项目
                .builder()
                .appComponent(appComponent)
                .f_4Module(new F_4Module(this))
                .build()
                .inject(this);
    }
    ...
    public View initView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_f_4, container, false);
    }
