...
import alan.mvptoolssample.mvp.model.api.Api;
...
//    public static String sDomain = Api.APP_DOMAIN;
    ...
    public void applyOptions(Context context, GlobalConfigModule.Builder builder) {
        ...
        if (SDCardUtils.isSDCardEnable()) {
            filePath = SDCardUtils.getSDCardPath() + MVPSampleConfig.CACHE_FILE_NAME;
        } else {
            filePath = context.getFilesDir().getPath() + MVPSampleConfig.CACHE_FILE_NAME;
        }
...
//                    okhttpBuilder.sslSocketFactory(); //支持 Https,详情请百度
                    okhttpBuilder.writeTimeout(MVPSampleConfig.NETWORK_TIME_OUT, TimeUnit.SECONDS);
